...
let listadoTareas = [{
    id: 1, 
    descripcion: 'Definir Objetivo de la Página',
    completado: false
},
{
    id: 2, 
    descripcion: 'Recopilar los Assets que serán usados en la página',
    completado: false
},
{
    id: 3, 
    descripcion: 'Identificar Interacciones deseables del User con el Website',
    completado: false
}]
